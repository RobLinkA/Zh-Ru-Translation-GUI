...
# 请填写您的MODEL_NAME和openai.api_key
...
def translate(input_text, reference_translation):
    responses = []
...
reference_translation = gr.Textbox(label="参考译文", lines=12, placeholder="请输入已经人工翻译过的参考译文（可选）")
...
gr.Interface(
    fn=translate,
    inputs=[input_text, reference_translation],
